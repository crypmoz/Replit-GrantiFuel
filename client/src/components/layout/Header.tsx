      ...
      <div className="flex justify-between items-center px-4 py-3 sm:px-6 lg:px-8">
        <div className="flex items-center">
          <button 
            ...
            className="text-gray-500 hover:text-gray-700 md:hidden mr-3 dark:text-gray-400 dark:hover:text-gray-200"
          >
                  ...
                  <li key={item.href}>
                    <div className="flex items-center">
                      ...
                      {index === breadcrumbs.length - 1 ? (
                        <span className={index > 0 ? "ml-2 text-gray-700 dark:text-gray-300" : "text-primary dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300"}>
                          {item.label}
                        </span>
                      ) : (
                        <Link 
